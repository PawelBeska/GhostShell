    ...
    <div class="navbar navbar-default">
        <div class="navbar-header">
            <a class="navbar-brand navbar-brand-center" href="index.html">
                <img class="navbar-brand-logo" src="{{URL::asset('assets/panel/img/logo_panel.png')}}" alt="Elephant">
            </a>
                  ...
                  <span class="visible-xs-block">
                    ...
                    <li class="dropdown hidden-xs">
                        <button class="navbar-account-btn" data-toggle="dropdown" aria-haspopup="true">
                            <img class="rounded" width="36" height="36" src="{{URL::asset('assets/panel/img/logo.png')}}" alt="Teddy Wilson">
                            {{Auth()->user()->first_name.' '.Auth()->user()->last_name}}
                            <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li class="navbar-upgrade-version">Wersja: 1.0.0</li>
                            <li class="divider"></li>
