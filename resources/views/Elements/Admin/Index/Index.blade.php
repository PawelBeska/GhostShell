    ...
    <div class="layout-content-body">
        <div class="title-bar">
            <h1 class="title-bar-title">
                <span class="d-ib">Panel - Panel administracyjny</span>
                ...
                <div class="card">
                        ...
                        <span class="icon icon-flag"></span>
                            ...
                            <div class="media-middle media-body">
                                <h3 class="media-heading">
                                    <span class="fw-l">5 zleceń</span>

                                </h3>
                                <small>5 aktywnych zleceń.</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <strong>Zlecenia nad którymi pracujesz</strong>
                        </div>
                        <div class="card-body">
                            <div class="timeline">
                                ...
                                <div class="timeline-item">
                                    <div class="timeline-segment">
                                        <i class="timeline-media icon icon-cogs"></i>
                                    </div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <div class="timeline-row">
                                            A user sent a request to transfer a repository to another user or
                                            organization.
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                      ...
                      <span class="bg-gray sq-64 circle">
                        <span class="icon icon-code"></span>
                            ...
                            <div class="media-middle media-body">
                                <h3 class="media-heading">
                                    <span class="fw-l">5 programistów</span>

                                </h3>
                                <small>2 z 5 programistów online</small>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="media">
                                    <div class="media-middle media-body">
                                        <h6 class="media-heading">
                                            <span class="text-muted">Desing</span>
                                        </h6>
            ...
            <div class="col-md-4">
                      ...
                      <span class="bg-gray sq-64 circle">
                        <span class="icon icon-flag"></span>
                            ...
                            <div class="media-middle media-body">
                                ...
                                <small>2 Pracowników pracuje nad twoim zleceniem</small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <strong>Najaktywniejsi programiści</strong>
                    </div>
                    <div class="card-body" data-toggle="match-height">
                        <table class="table table-borderless table-middle">
                            ...
                            <tr>
                                ...
                                <td class="col-xs-6">
                                    <a class="link-muted" href="#">Raz4r</a>
                                </td>
                                <td class="col-xs-2">
                            ...
                            <tr>
                                ...
                                <td class="col-xs-6">
                                    <a class="link-muted" href="#">Cuckoo</a>
                                </td>
                                <td class="col-xs-2">
                                    <div class="text-right">185,117</div>
                                </td>
                                <td class="col-xs-3">
                                    <div class="progress progress-sm m-y-0">
                                        <div class="progress-bar progress-bar-primary" role="progressbar"
